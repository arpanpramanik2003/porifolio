        ...
        <div className="grid md:grid-cols-3 gap-12 mb-8">
              ...
              {quickLinks.map((link) => (
                <li key={link.to}>
                  <Link
                    ...
                    smooth
                    duration={500}
                    className="text-slate-400 hover:text-blue-400 transition-colors cursor-pointer inline-block"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          >
            ...
            <ul className="space-y-3 text-slate-400">
              <li>
                <a href={`mailto:${personalInfo.contact.email}`} className="hover:text-blue-400 transition-colors">
                  {personalInfo.contact.email}
                </a>
              </li>
              <li>
                <a href={`tel:${personalInfo.contact.phone}`} className="hover:text-blue-400 transition-colors">

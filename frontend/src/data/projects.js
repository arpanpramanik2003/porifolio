export const projectsData = [
  // Featured/Priority Projects
  {
    ...
    image: '/project-images/cropsense.jpg',
    featured: true,
  ...
  },
  {
    ...
    category: 'Deep Learning',
    image: '/project-images/chestx-ray.jpg',
    featured: true,
  ...
  },
  {
    ...
    featured: false,
    description: 'Full-stack AI research assistant that analyzes papers, detects gaps, and generates experiment plans or research problem statements.',
    fullDescription: 'PaperLens AI is a full-stack research assistant built with React + Vite frontend and FastAPI backend to accelerate academic workflows. It supports PDF/DOCX paper analysis, grounded follow-up Q&A, research gap detection, experiment planning, and problem generation. The backend uses a hybrid retrieval pipeline (FAISS + BM25, optional CrossEncoder reranking), Clerk JWT authentication, PostgreSQL via SQLAlchemy, and Groq-powered generation for high-quality structured outputs.',
    tech: ['React', 'Vite', 'TypeScript', 'Tailwind CSS', 'FastAPI', 'SQLAlchemy', 'PostgreSQL', 'Clerk', 'Groq API', 'FAISS', 'BM25', 'sentence-transformers', 'pdfplumber'],
    features: [
